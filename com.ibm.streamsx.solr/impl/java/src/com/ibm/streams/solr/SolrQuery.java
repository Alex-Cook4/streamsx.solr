...
public class SolrQuery extends AbstractOperator {
	...
	private final Logger trace = Logger.getLogger(SolrQuery.class
			.getCanonicalName());
	private String solrURL = "http://localhost:8983/solr";
	private String collection = "myCollection";
	...
	public synchronized void initialize(OperatorContext context)
        ...
        collectionURL = solrURL + "/" + collection;
    ...
    public final void process(StreamingInput<Tuple> inputStream, Tuple tuple)
		...
		if (!fullQueryProvided){
			queryString = queryEngine.buildQuery(collectionURL, responseFormat, numberOfRows, omitHeader, queryLogic);//"http://g0601b02:8983/solr/transcriptions/select/?wt=xml&q=*:*%20AND%20starttime:[*%20TO%202016-09-09T9:23:43Z]&fl=id&rows=100";
		} else {
